...
namespace ArelympApi.Migrations
{
    ...
    [Migration("20240509212522_CharacterLoadoutUserForeignKeyUpdate")]
    partial class CharacterLoadoutUserForeignKeyUpdate
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DataAccess.Entities.AssignedItem", b =>
                {
                    ...
                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("AssignedItemId"));
                    ...
                    b.HasAlternateKey("UserId", "ItemId");
            ...
            modelBuilder.Entity("DataAccess.Entities.Item", b =>
                {
                    b.HasOne("DataAccess.Entities.Item", null)
                        .WithMany("BindedCharacter")
                        .HasForeignKey("BindedCharacterId");
